...
CONFIG_MANAGER = {
    ...
    "chain_debate_weights": {
        ...
        "油脂油料": {
            ...
            "chain_logic_weight": 1.2,
            "macro_weight": 0.6,
        },
        "谷物软商品": {
            "technical_weight": 0.7,
            "fundamental_weight": 1.5,
            "chain_logic_weight": 0.8,
            "macro_weight": 0.5,
        },
...
def get_chain_debate_weight(chain_name: str) -> dict:
    ...
    return CONFIG_MANAGER["chain_debate_weights"].get(
        chain_name, {"technical_weight": 1.0, "fundamental_weight": 1.0, "chain_logic_weight": 1.0, "macro_weight": 1.0}
    )
