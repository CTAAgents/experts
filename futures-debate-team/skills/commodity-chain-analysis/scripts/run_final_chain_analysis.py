...
FUNDAMENTAL_NOTES = {
    ...
    "贵金属": [
        "沪金价格911.4元/克（数据来源：scan_all.py --dual扫描结果，截至7月4日收盘）",
    ],
    "油脂油料": [
        "豆粕2962元/吨，菜粕2257元/吨，ADX均<20，无明显趋势（数据来源：scan_all.py --dual扫描结果，截至7月4日收盘）",
    ],
    "谷物软商品": [
        "L1L4信号分化：棉花/花生/生猪偏多 vs 玉米/白糖/鸡蛋偏空（数据来源：scan_all.py --dual扫描结果，截至7月4日收盘）",
    ],
    "煤化工": [
        "甲醇2377元/吨，ADX=80.6为全市场最高，下行趋势极强但接近超卖区域（数据来源：scan_all.py --dual扫描结果，截至7月4日收盘）",
    ],
    "橡胶": [
        "橡胶16755元/吨，NR14465元/吨，BR12125元/吨，三者均为下行趋势（数据来源：scan_all.py --dual扫描结果，截至7月4日收盘）",
    ],
    "纸浆造纸": [
        "纸浆4752元/吨，双胶纸3958元/吨，下游op跌幅小于上游sp（数据来源：scan_all.py --dual扫描结果，截至7月4日收盘）",
    ],
}
