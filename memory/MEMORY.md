...
5. **Phase5** 策执远（方案，依赖Phase1+Phase3）≤5并发
...
- **(1) 趋势跟踪**：channel_breakout_strategy（DC20/DC55/布林带/ADX/ATR/均线排列）+ run_l1l4_scan.py（多周期分层）
- **(4) 多因子量化**：run_factor_timing_scan.py（carry/momentum/inventory_pct/skew/corr）
