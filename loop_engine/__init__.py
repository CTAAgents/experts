"""
loop_engine — Loop Engine（L1 Meta-Loop + L2 Evolution Loop + L3 Portfolio Loop）
...
核心模块：
    ...
    - portfolio_loop: L3 主循环（组合构建 + 正交化 + 衰减检验 + 注入 FDT）

版本: v8.10.0（Phase 2 L1 Meta-Loop 落地 + Phase 3 L3 Portfolio Loop 落地）
基线: LOOP_ENGINEERING_INTEGRATION_PLAN.md v1.1
"""
