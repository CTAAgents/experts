"""
tests/loop_engine/test_portfolio_loop.py — L3 Portfolio Loop 测试
...
from loop_engine.portfolio_loop import (
    L3Error,
    L3Verifier,
...
class TestPortfolioLoop:
    ...
    def test_circuit_breaker(self, tmp_portfolio_dir, tmp_elite_dir):
        ...
        with patch("loop_engine.portfolio_loop.load_elite_factors") as mock_load:
