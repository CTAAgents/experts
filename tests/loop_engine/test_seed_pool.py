"""tests/loop_engine/test_seed_pool.py — 种子池测试。"""

from __future__ import annotations

import pytest

from loop_engine.contracts import FactorProgram
from loop_engine.seed_pool import SeedPool, get_default_seed_pool
...
def test_seed_factor_code_is_compilable():
    ...
    from loop_engine.factor_program import validate_factor_code
    pool = SeedPool()
    for seed in pool.load_all_seeds():
